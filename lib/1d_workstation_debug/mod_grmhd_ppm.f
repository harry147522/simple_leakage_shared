...
contains
  ...
  subroutine grmhd_ppm_flatcd(rec_from, rec_to, ixImin1,ixImax1, ixOmin1,&
     ixOmax1, ixLmin1,ixLmax1, ixRmin1,ixRmax1, w, d2w, drho, dp)
    ...
    call phys_get_csound2(ixImin1,ixImax1, ixOmin1,ixOmax1,w(ixImin1:ixImax1,&
        1:nprim), gamma_eos_tmp(ixImin1:ixImax1))
    ...
    dp(ixOmin1:ixOmax1) = gamma_eos_tmp(ixOmin1:ixOmax1) * &
       abs(d2w_press(ixOmin1:ixOmax1)) / min( w(ixLmin1:ixLmax1, press_),&
        w(ixRmin1:ixRmax1, press_) )
  end subroutine grmhd_ppm_flatcd

  subroutine grmhd_ppm_flatsh(ixImin1,ixImax1, ixOmin1,ixOmax1, ixLLmin1,&
