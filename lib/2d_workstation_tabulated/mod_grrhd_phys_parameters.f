module mod_grrhd_phys_parameters
  ...
  subroutine grrhd_get_lambda(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
     ...
     double precision                :: cs2(ixImin1:ixImax1,ixImin2:ixImax2),&
         v2(ixImin1:ixImax1,ixImin2:ixImax2)
     double precision                :: lfac(ixImin1:ixImax1,ixImin2:ixImax2),&
         lfac2(ixImin1:ixImax1,ixImin2:ixImax2)
     double precision                :: pi(ixImin1:ixImax1,ixImin2:ixImax2)
     double precision                :: chi(ixImin1:ixImax1,ixImin2:ixImax2) !closure function
     double precision                :: coeff_thin(ixImin1:ixImax1,&
        ixImin2:ixImax2), coeff_thick(ixImin1:ixImax1,ixImin2:ixImax2)
     double precision                :: lambda_thin(ixImin1:ixImax1,&
        ixImin2:ixImax2, 1:2), lambda_thick(ixImin1:ixImax1,ixImin2:ixImax2,&
         1:2)
     ...
     call grrhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
         ...
         v2=v2(ixImin1:ixImax1,ixImin2:ixImax2), lfac2=lfac2(ixImin1:ixImax1,&
     ...
     if (.not.use_radiation) then
        ...
        tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( cs2(ixOmin1:ixOmax1,&
           ...
           ixOmin2:ixOmax2) ) / gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idim,&
            idim) - vel(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
        ...
        tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( 1.0d0 / &
        ...
        do idir = 1, ndir
           vel(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = prim(ixOmin1:ixOmax1,&
              ixOmin2:ixOmax2, nu_F_over_E(idir)) * prim(ixOmin1:ixOmax1,&
              ixOmin2:ixOmax2, nu_E) 
        end do
        ! get sqrt F
        tmp2 = 0.0d0
        do idir = 1, ndir
           tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = tmp2(ixOmin1:ixOmax1,&
              ...
              idir) * vel(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir)**2
        end do
        tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( tmp2(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) )
    
        ! fixme: need to up index
        tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dabs( vel(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2, idim) ) / tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    
        lambda_thin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           1) = - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            beta(idim)) + prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            alp_) * tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) 
        lambda_thin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           2) = - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            beta(idim)) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            alp_) * tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) 

        ! now work out lambda_thick
        pi(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = prim(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2, alp_) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            W_vel(idim)) / lfac2(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
        tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 2.0d0 * prim(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2, alp_) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            W_vel(idim))
        tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( prim(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2, alp_) * ( 2.0d0 * lfac2(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) + 1.0d0 ) / gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            idim, idim) - 2.0d0 * lfac2(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) * pi(ixOmin1:ixOmax1,ixOmin2:ixOmax2)**2 ) 

        lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           1) = - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            beta(idim)) + ( tmp1(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) + tmp2(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) ) / ( 2.0d0 * lfac2(ixOmin1:ixOmax1,&
        ...
        lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           1) = min( - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            beta(idim)) + pi(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
            lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1) )
        lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           2) = min( - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            beta(idim)) + pi(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
            lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2) )
    
        ! now combine two lambdas
        ! loop over points
        do ix1 = ixOmin1,ixOmax1 
        do ix2 = ixOmin2,ixOmax2 
           chi(ix1,ix2) = minerbo_closure_func( prim(ix1,ix2, nu_zeta) )
           coeff_thin(ix1,ix2) = c_thin(chi(ix1,ix2))
           coeff_thick(ix1,ix2) = 1.0d0 - coeff_thin(ix1,ix2)
        end do
        end do ! end loop for every points
        lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1) = coeff_thin(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) * lambda_thin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           1) + coeff_thick(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) * lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)
        lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2) = coeff_thin(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) * lambda_thin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           2) + coeff_thick(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2) * lambda_thick(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2)
     end if
  end subroutine grrhd_get_lambda

  !> This subroutine fix the abnormal values in conserved variables !
  subroutine grrhd_handle_small_values(prim, x, ixImin1,ixImin2,ixImax1,&
    ...
    case ("replace")
       ...
       do ix2 = ixOmin2,ixOmax2 
          ...
          if ( need_to_fix_eos .and. update_eos ) then
             call grrhd_update_eos_one_point(prim(ix1,ix2,1:nprim))
          end if
       enddo
       enddo
  ...
  subroutine grrhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
      ixOmin1,ixOmin2,ixOmax1,ixOmax2, prim, x, Pij, gamma, lfac2, lfac, v2,&
      h )
    use mod_global_parameters
    use mod_geometry
    use mod_rootfinding
    ...
    double precision, intent(out), optional :: Pij(ixImin1:ixImax1,&
       ixImin2:ixImax2,1:3,1:3)

    integer                                 :: idir, jdir
    double precision                        :: W2v2(ixImin1:ixImax1,&
       ixImin2:ixImax2), v2_tmp(ixImin1:ixImax1,ixImin2:ixImax2) !
    ...
    double precision                        :: E(ixImin1:ixImax1,&
       ixImin2:ixImax2), F2(ixImin1:ixImax1,ixImin2:ixImax2),&
        Fi(ixImin1:ixImax1,ixImin2:ixImax2,1:ndir) !F_i
    double precision                        :: v_dot_F(ixImin1:ixImax1,&
       ixImin2:ixImax2) !vi,vi F_i
    double precision                        :: gamma_H(ixImin1:ixImax1,&
       ixImin2:ixImax2,1:ndir)
    integer                                 :: ix1,ix2 
    ! --------------   variables needed to get Pij  ------------- 
    double precision                        :: chi(ixImin1:ixImax1,&
       ixImin2:ixImax2) !closure function
    double precision                        :: coeff_thin(ixImin1:ixImax1,&
       ixImin2:ixImax2), coeff_thick(ixImin1:ixImax1,ixImin2:ixImax2)
    ...
    v2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = W2v2(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) / lfac2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    if ( present(v2) ) v2(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) = v2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    ...
    E(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
        nu_E)
    ! Note that the momentum density in prim is F_i / E
    do idir = 1, ndir
       Fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = prim(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, nu_F_over_E(idir)) * E(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2)
    end do
    ! calculate the F^i F_i
    F2 = 0.0d0
    do idir = 1, ndir
       F2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = F2(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) + Fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           idir)**2 / gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir, idir)
    end do
    ! v^i * F_i
    v_dot_F = 0.0d0
    do idir = 1, ndir
       v_dot_F(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = v_dot_F(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) + prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           W_vel(idir)) / lfac_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * Fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir)
    end do
    ...
    if ( present(Pij) ) then
       ...
       do idir = 1, ndir; do jdir = 1, ndir
          Pij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
             jdir) = coeff_thin(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * E(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2)/F2(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * Fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             idir) * Fi(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir)
       end do; end do

       ! optically thick part of pressure tensor
       J_over_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 1.0d0 / (2.0d0 * &
          lfac2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) + 1.0d0) * ( (2.0d0 * &
          lfac2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) - 1.0d0) * &
          E(ixOmin1:ixOmax1,ixOmin2:ixOmax2) - 2.0d0 * &
          lfac2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) * v_dot_F(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) )
       do idir = 1, ndir
          gamma_H(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir) = Fi(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2,idir)/gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
             idir)/lfac_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) + prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             W_vel(idir)) / (2.0d0 * lfac2_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) + 1.0d0) * ( (4.0d0 * lfac2_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) + 1.0d0) * v_dot_F(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) - 4.0d0 * lfac2_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * E(ixOmin1:ixOmax1,ixOmin2:ixOmax2) )
       end do

       do idir = 1, ndir
          Pij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,idir) = Pij(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2,idir,idir) + coeff_thick(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * ( J_over_3(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * ( 4.0d0 * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             W_vel(idir)) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             W_vel(idir)) + 1.0d0 / gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
             idir)) )
       end do

       do idir = 1, ndir; do jdir = 1, ndir
          Pij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,jdir) = Pij(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2,idir,jdir) + coeff_thick(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * ( lfac_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) * (gamma_H(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             idir) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
              W_vel(jdir)) / lfac_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) +gamma_H(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             jdir) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
              W_vel(idir)) / lfac_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) ) ) 
       end do; end do
    end if
  end subroutine grrhd_get_intermediate_variables

  !> the implementation here follows SpECTRE https://spectre-code.org/
  subroutine grrhd_get_nu_zeta(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, prim, x, v2_in, lfac_in, lfac2_in, gamma_in )
    use mod_global_parameters
    use mod_geometry
    use mod_rootfinding
    implicit none
    ...
    double precision, intent(in), optional  :: gamma_in(ixImin1:ixImax1,&
       ixImin2:ixImax2,1:3,1:3)
    double precision, intent(in), optional  :: v2_in(ixImin1:ixImax1,&
       ixImin2:ixImax2) !
    double precision, intent(in), optional  :: lfac2_in(ixImin1:ixImax1,&
       ixImin2:ixImax2) !Lorentz factor square
    double precision, intent(in), optional  :: lfac_in(ixImin1:ixImax1,&
       ixImin2:ixImax2) !Lorentz factor

    integer                                 :: ix1,ix2 
    integer                                 :: idir, jdir
    double precision                        :: gamma(ixImin1:ixImax1,&
       ixImin2:ixImax2,1:3,1:3)
    double precision                        :: v2(ixImin1:ixImax1,&
       ixImin2:ixImax2), lfac2(ixImin1:ixImax1,ixImin2:ixImax2),&
        lfac(ixImin1:ixImax1,ixImin2:ixImax2) 
    integer                                 :: error_code = -1
    ! --------------   variables needed to solve zeta  ------------- 
    double precision                        :: E, F2, Fi(1:ndir) ! F_i
    double precision                        :: v_dot_F  !  vi,vi F_i
    ...
    if ( .not. ( present(gamma_in) .or. present(lfac_in) .or. &
     ...
     call grrhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
       ...
       gamma(ixImin1:ixImax1,ixImin2:ixImax2,1:3,&
          1:3) = gamma_in(ixImin1:ixImax1,ixImin2:ixImax2,1:3,1:3) 
       lfac(ixImin1:ixImax1,ixImin2:ixImax2) = lfac_in(ixImin1:ixImax1,&
          ixImin2:ixImax2) 
       lfac2(ixImin1:ixImax1,ixImin2:ixImax2) = lfac2_in(ixImin1:ixImax1,&
          ixImin2:ixImax2) 
       v2(ixImin1:ixImax1,ixImin2:ixImax2) = v2_in(ixImin1:ixImax1,&
          ixImin2:ixImax2) 
    end if
    ...
    do ix2 = ixOmin2,ixOmax2 
       E = prim(ix1,ix2, nu_E)
       ! Note that the momentum density in prim is F_i / E
       Fi(1:ndir) = prim(ix1,ix2, nu_F_over_E(1:ndir)) * E
   
       ! calculate the F^i F_i
       F2 = 0.0d0
       do idir = 1, ndir
          F2 = F2 + Fi(idir)**2 / gamma(ix1,ix2,idir,idir)
       end do
       ! if the velocity can be ignored, assume that
       ! fluid frame = inertial frame
       if ( v2(ix1,ix2) <= smalldouble ) then
       ...
       ! expensive closure calculation
          ...
          zeta = min( max( prim(ix1,ix2, nu_zeta), 0.0d0), 1.0d0)
      
          ! v^i * F_i
          v_dot_F = 0.0d0
          do idir = 1, ndir
             v_dot_F = v_dot_F + prim(ix1,ix2, W_vel(idir)) / lfac(ix1,&
                ix2) * Fi(idir)
          end do
          ! Decomposition of the fluid-frame energy density:
          ! J = J_0 + coeff_thin * J_Thin + coeff_thick * J_Thick
          J_0 = lfac2(ix1,ix2) * ( E - 2.0d0 * v_dot_F )
          J_thin = lfac2(ix1,ix2) * E * v_dot_F**2 / F2 
          J_thick = ( lfac2(ix1,ix2) - 1.0d0 ) / ( 1.0d0 + 2.0d0 * lfac2(ix1,&
             ix2) ) * ( 4.0d0 * lfac2(ix1,&
             ix2) * v_dot_F + E * ( 3.0d0 - 2.0d0 * lfac2(ix1,ix2) ) )
          ...
          H_0_t = lfac(ix1,ix2) * ( J_0 + v_dot_F - E )
          H_0_v = lfac(ix1,ix2) * J_0 
          H_0_F = - lfac(ix1,ix2)
          H_thin_t = lfac(ix1,ix2) * J_thin
          H_thin_v = H_thin_t
          H_thin_F = lfac(ix1,ix2) * E * v_dot_F / F2
          H_thick_t = lfac(ix1,ix2) * J_thick
          H_thick_v = H_thick_t + lfac(ix1,ix2) / ( 2.0d0 * lfac2(ix1,&
             ix2) + 1.0d0 ) * ( (3.0d0 - 2.0d0 * lfac2(ix1,&
             ix2)) * E - (1.0d0 - 2.0d0 * lfac2(ix1,ix2)) * v_dot_F )
          H_thick_F = lfac2(ix1,ix2) * v2(ix1,ix2)
          ...
          H2_0 = - H_0_t**2 + H_0_v**2 * v2(ix1,&
             ix2) + H_0_F**2 * F2 + 2.0d0 * H_0_v * H_0_F * v_dot_F
          H2_thin = 2.0d0 * (H_0_v * H_thin_v * v2(ix1,&
             ix2) + H_0_F * H_thin_F * F2 + H_0_v * H_thin_F * v_dot_F + H_0_F &
             * H_thin_v * v_dot_F - H_0_t * H_thin_t)
          H2_thick = 2.0d0 * (H_0_v * H_thick_v * v2(ix1,&
             ix2) + H_0_F * H_thick_F * F2 + H_0_v * H_thick_F * v_dot_F + &
             H_0_F * H_thick_v * v_dot_F - H_0_t * H_thick_t)
          H2_thin_thick = 2.0d0 * (H_thin_v * H_thick_v * v2(ix1,&
             ix2) + H_thin_F * H_thick_F * F2 + H_thin_v * H_thick_F * v_dot_F &
             + H_thin_F * H_thick_v * v_dot_F - H_thin_t * H_thick_t)
          H2_thick_thick = (H_thick_v**2) * v2(ix1,&
             ix2) + (H_thick_F**2) * F2 + 2.0d0 * H_thick_v * H_thick_F * &
             v_dot_F - (H_thick_t**2) 
          H2_thin_thin = (H_thin_v**2) * v2(ix1,&
             ix2) + (H_thin_F**2) * F2 + 2.0d0 * H_thin_v * H_thin_F * v_dot_F &
             - (H_thin_t**2)
