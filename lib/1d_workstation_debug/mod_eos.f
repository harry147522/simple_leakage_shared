...
module mod_eos
  ...
  procedure(sub_get_temp_one_grid), pointer        :: eos_get_temp_one_grid    &
             => null()
  procedure(sub_get_all_one_grid), pointer        :: eos_get_all_one_grid      &
           => null()
  ...
  abstract interface
     ...
     subroutine sub_get_all_one_grid(rho,temp,ye,eps,prs,ent,cs2,dedt,dpderho,&
     ...
     end subroutine sub_get_all_one_grid
