...
!       evaluate function values
       ...
       a8(1) = dxyzi * ( fh(1,8) - fh(1,1) + fh(1,2) + fh(1,3) +&
                        fh(1,4) - fh(1,5) - fh(1,6) - fh(1,7) )
...
!
!
      double precision  fh(1,8,nvars), delx(1), dely(1), delz(1), &
           a1(1,nvars), a2(1,nvars), a3(1,nvars), a4(1,nvars), &
           a5(1,nvars), a6(1,nvars), a7(1,nvars), a8(1,nvars)
