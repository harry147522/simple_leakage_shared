...
module mod_physics
  ...
  integer :: ye_ = -1
  !> Index of the leak_tau
  integer, allocatable :: leaktau(:)
  !> Index of the chi for diffusion
  integer, allocatable :: chi(:)
  !> Index of the zeta for diffusion
  ...
  abstract interface
     ...
     subroutine sub_convert(ixImin1,ixImax1, ixOmin1,ixOmax1, cons, prim, x)
       use mod_global_parameters
     ...
     subroutine sub_update_eos(ixImin1,ixImax1, ixOmin1,ixOmax1, prim)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(inout) :: prim(ixImin1:ixImax1, nprim)
     end subroutine sub_update_eos

     subroutine sub_modify_wLR(ixImin1,ixImax1, ixOmin1,ixOmax1, consL, consR,&
         primL, primR, s, idir)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idir
     ...
     subroutine sub_modify_flux(ixImin1,ixImax1, ixOmin1,ixOmax1, consL, consR,&
     ...
     subroutine sub_get_cmax(prim, x, ixImin1,ixImax1, ixOmin1,ixOmax1, idim,&
         cmax)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idim
     ...
     subroutine sub_get_cbounds(consL, consR, primL, primR, x, ixImin1,ixImax1,&
         ixOmin1,ixOmax1, idim, cmax, cmin)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idim
       double precision, intent(in)    :: consL(ixImin1:ixImax1, ncons),&
           consR(ixImin1:ixImax1, ncons)
       double precision, intent(in)    :: primL(ixImin1:ixImax1, nprim),&
           primR(ixImin1:ixImax1, nprim)
       double precision, intent(in)    :: x(ixImin1:ixImax1, 1:1)
       double precision, intent(inout) :: cmax(ixImin1:ixImax1)
     ...
     subroutine sub_get_flux(wC, w, x, ixImin1,ixImax1, ixOmin1,ixOmax1, idim,&
       ...
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idim
       double precision, intent(in)    :: wC(ixImin1:ixImax1, 1:ncons)
     ...
     subroutine sub_add_source_geom(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1,&
     ...
     subroutine sub_add_source(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1, primCT,&
     ...
     subroutine sub_get_dt(prim, ixImin1,ixImax1, ixOmin1,ixOmax1, dtnew, dx1,&
         x)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
     ...
     subroutine sub_check_prim(ixImin1,ixImax1, ixOmin1,ixOmax1, prim,&
         prim_flag)
       use mod_global_parameters
       integer, intent(in)          :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(in) :: prim(ixImin1:ixImax1,nprim)
       integer, intent(inout)       :: prim_flag(ixGlo1:ixGhi1)
     ...
     subroutine sub_small_values(prim, x, ixImin1,ixImax1, ixOmin1,ixOmax1,&
         update_eos, subname)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1,ixOmin1,ixOmax1
     ...
     subroutine sub_get_var_from_state(ps_in, ixImin1,ixImax1, ixOmin1,ixOmax1,&
         out)
       use mod_global_parameters
       type(state), intent(in)         :: ps_in
       integer, intent(in)           :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(out) :: out(ixImin1:ixImax1)
     end subroutine sub_get_var_from_state

     subroutine sub_get_var(ixImin1,ixImax1, ixOmin1,ixOmax1, prim, out)
       use mod_global_parameters
       integer, intent(in)           :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(in)  :: prim(ixImin1:ixImax1, nprim)
       double precision, intent(out) :: out(ixImin1:ixImax1)
     ...
     subroutine sub_update_faces(ixImin1,ixImax1,ixOmin1,ixOmax1,qdt,wprim,fC,&
        fE,sCT,s)
       use mod_global_parameters
       integer, intent(in)                :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(in)       :: qdt
       ...
       ! velocity structure
       type(state)                        :: sCT, s
       double precision, intent(in)       :: fC(ixImin1:ixImax1,1:ncons,&
          1:ndim)
...
contains
  ...
  subroutine dummy_convert(ixImin1,ixImax1, ixOmin1,ixOmax1, cons, prim, x)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(inout) :: prim(ixImin1:ixImax1, nprim)
    double precision, intent(inout) :: cons(ixImin1:ixImax1, ncons)
  ...
  subroutine dummy_update_eos(ixImin1,ixImax1, ixOmin1,ixOmax1, prim)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(inout) :: prim(ixImin1:ixImax1,1:nprim)
  end subroutine dummy_update_eos

  subroutine dummy_modify_wLR(ixImin1,ixImax1, ixOmin1,ixOmax1, consL, consR,&
      primL, primR, s, idir)
    use mod_global_parameters
  ...
  subroutine dummy_modify_flux(ixImin1,ixImax1, ixOmin1,ixOmax1, consL, consR,&
      primL, primR, xi, s, idir, f)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1, idir
    double precision, intent(inout) :: consL(ixImin1:ixImax1,1:ncons),&
  ...
  subroutine dummy_add_source_geom(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1,&
      consCT, primCT, cons, x)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in)    :: qdt, x(ixImin1:ixImax1, 1:1)
  ...
  subroutine dummy_add_source(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1, primCT,&
      cons, x, qsourcesplit, active)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in)    :: qdt
  ...
  subroutine dummy_check_prim(ixImin1,ixImax1, ixOmin1,ixOmax1, prim, w_flag)
    use mod_global_parameters
    integer, intent(in)          :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in) :: prim(ixImin1:ixImax1,nprim)
    integer, intent(inout)       :: w_flag(ixGlo1:ixGhi1)

    w_flag(ixOmin1:ixOmax1) = 0             ! All okay
  ...
  subroutine dummy_small_values(prim, x, ixImin1,ixImax1, ixOmin1,ixOmax1,&
      update_eos, subname)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1,ixOmin1,ixOmax1
    double precision, intent(inout) :: prim(ixImin1:ixImax1,1:nprim)
  ...
  subroutine dummy_update_faces(ixImin1,ixImax1,ixOmin1,ixOmax1,qdt,wprim,fC,&
     fE,sCT,s)
    use mod_global_parameters
    integer, intent(in)                :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in)       :: qdt
