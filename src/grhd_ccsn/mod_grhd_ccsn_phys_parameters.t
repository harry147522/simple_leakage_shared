...
!    call eos_get_cs2_one_grid(prim(cs2_),prim( rho_),prim( eps_), ye=prim( ye_))
  ...
  subroutine grhd_ccsn_get_intermediate_variables(ixI^L, ixO^L, prim, x, &
  ...
  subroutine grhd_ccsn_get_lambda(ixI^L, ixO^L, idim, prim, x, lambda)
     use mod_global_parameters
  ...
  subroutine grhd_ccsn_handle_small_values(prim, x, ixI^L, ixO^L, update_eos, subname)
    use mod_global_parameters
