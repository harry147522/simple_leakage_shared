...
contains
  ...
  subroutine grhd_ccsn_add_source(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1,&
      primCT, cons, x, qsourcesplit, active)
    use mod_global_parameters
    use mod_geometry
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
  ...
  subroutine grhd_ccsn_add_source_geom(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1,&
