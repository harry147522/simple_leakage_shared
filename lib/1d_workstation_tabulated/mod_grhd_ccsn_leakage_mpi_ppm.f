...
contains
  ...
  subroutine grhd_ccsn_leakage_mpi_ppm_flatcd(rec_from, rec_to, ixImin1,&
     ixImax1, ixOmin1,ixOmax1, ixLmin1,ixLmax1, ixRmin1,ixRmax1, w, d2w, drho,&
      dp)
  ...
  subroutine grhd_ccsn_leakage_mpi_ppm_flatsh(ixImin1,ixImax1, ixOmin1,ixOmax1,&
