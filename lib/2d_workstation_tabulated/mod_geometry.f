...
contains
  ...
  subroutine get_surface_area(s,ixGmin1,ixGmin2,ixGmax1,ixGmax2)
    ...
    case (spherical)
      ...
      s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)=(x(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2,1)+0.5d0*drs(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2))**2  *2.0d0*dsin(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2))*dsin(0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))
      ...
      s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2)=(x(ixGmin1:ixGmax1,&
         ...
         2)+0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))

      

      
      
      s%surfaceC(0,ixGmin2:ixGmax2,1)=(x(1,ixGmin2:ixGmax2,1)-0.5d0*drs(1,&
         ixGmin2:ixGmax2))**2 *2.0d0*dsin(x(1,ixGmin2:ixGmax2,&
         2))*dsin(0.5d0*dx2(1,ixGmin2:ixGmax2))

      s%surfaceC(ixGmin1:ixGmax1,0,2)=(x(ixGmin1:ixGmax1,1,&
         1)**2 +drs(ixGmin1:ixGmax1,1)**2/12.0d0) *drs(ixGmin1:ixGmax1,&
         1)*dsin(x(ixGmin1:ixGmax1,1,2)-0.5d0*dx2(ixGmin1:ixGmax1,1))
     
      

      s%surface(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)=x(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2,1)**2  *2.0d0*dsin(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2))*dsin(0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))
    ...
    case (cylindrical)
      ...
      s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2)=x(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2,1)*drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2)
  ...
  subroutine get_christoffel(s,ixGmin1,ixGmin2,ixGmax1,ixGmax2)
    use mod_global_parameters
    ...
    double precision :: x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ndim),&
        drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2), dx2(ixGmin1:ixGmax1,&
       ixGmin2:ixGmax2), dx3(ixGmin1:ixGmax1,ixGmin2:ixGmax2)
    integer          :: h1xmin1,h1xmin2,h1xmax1,h1xmax2, h2xmin1,h2xmin2,&
       h2xmax1,h2xmax2
    ...
    case (spherical)
      h1xmin1=ixGmin1-kr(1,1);h1xmin2=ixGmin2-kr(1,2);h1xmax1=ixGmax1-kr(1,1)
      h1xmax2=ixGmax2-kr(1,2);  h2xmin1=ixGmin1-kr(2,1)
      h2xmin2=ixGmin2-kr(2,2);h2xmax1=ixGmax1-kr(2,1);h2xmax2=ixGmax2-kr(2,2);
      x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)=s%x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         1)
      ...
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,&
         2)=0.5d0 * (s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         1) - s%surfaceC(h1xmin1:h1xmax1,h1xmin2:h1xmax2,&
         1)) / s%dvolume(ixGmin1:ixGmax1,ixGmin2:ixGmax2)
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,2,&
         1)=s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,2)
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,3,&
         1)=s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,2)
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,1,&
         3)=s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,2)

      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1,2,&
         2)=-0.25d0 * ((x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         1)+0.5d0*drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**&
         2*s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1) - (x(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2,1)-0.5d0*drs(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2))**2*s%surfaceC(h1xmin1:h1xmax1,h1xmin2:h1xmax2,&
         1)) / s%dvolume(ixGmin1:ixGmax1,ixGmin2:ixGmax2)

      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1,3,&
         3)=-0.25d0 / s%dvolume(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2) * ((x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         1)+0.5d0*drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**4 - &
         (x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)-0.5d0*drs(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2))**4) *( (dcos(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2)+0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**3/3.0d0 - &
         dcos(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2)+0.5d0*dx2(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2))) -(dcos(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2)-0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**3/3.0d0 - &
         dcos(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2)-0.5d0*dx2(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2))) )

      
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,3,&
         3)= - ( (dsin(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2)+0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**&
         2)*s%surfaceC(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2) - (dsin(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
         2)-0.5d0*dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2))**&
         2)*s%surfaceC(h2xmin1:h2xmax1,h2xmin2:h2xmax2,&
         2) ) / 3.0d0 / s%dvolume(ixGmin1:ixGmax1,ixGmin2:ixGmax2) 

      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,2,&
         3)=dcos(x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2))/dsin(x(ixGmin1:ixGmax1,&
         ixGmin2:ixGmax2,2))
      s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,3,&
         2)=s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,2,3)
    ...
    case (cylindrical)
      ...
      if ( z_ == 2 ) then
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1,3,&
            3)= - (x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
            1)**2 +drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2)**2/12.0d0) / &
            x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,1,&
            3)= 1.0d0 / x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,3,&
            1) = s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,3,1,3)
      else
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1,2,&
            2)= - (x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,&
            1)**2 +drs(ixGmin1:ixGmax1,ixGmin2:ixGmax2)**2/12.0d0) / &
            x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,&
            2)= 1.0d0 / x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,1)
         s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,2,&
            1) = s%christoffel(ixGmin1:ixGmax1,ixGmin2:ixGmax2,2,1,2)
      end if
    case default
  ...
  subroutine get_sqrt_gamma_hat(x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, sqrt_gamma)
    use mod_global_parameters
    ...
    select case (coordinate)
    case (Cartesian)
      sqrt_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 1.0d0
    case (cylindrical)
      sqrt_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dabs( x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, 1) )
    case (spherical)
      sqrt_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dabs( x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, 1)**2  * dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          2)) )
    case default
      call mpistop("Sorry, coordinate unknown")
    end select
  ...
  subroutine get_gamma_ij_hat(x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, gamma)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2
    double precision, intent(out) :: gamma(ixImin1:ixImax1,ixImin2:ixImax2,&
        1:3, 1:3)
    double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2, 1:2)
    ...
    select case (coordinate)
    case (Cartesian)
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,1) = 1.0d0
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2) = 1.0d0
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,3) = 1.0d0
    case (cylindrical)
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,1) = 1.0d0
      if ( z_ == 2 ) then
         gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2) = 1.0d0
         gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,3) = x(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2, 1)**2
      else
         gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,3) = 1.0d0
         gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2) = x(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2, 1)**2
      end if
    case (spherical)
      ...
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2) = x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, 1)**2
      gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,3) =  gamma(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,2,2)  * dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          2))**2
    case default
      call mpistop("Sorry, coordinate unknown")
    end select
  ...
  subroutine get_natural2orthonormal(x, ixImin1,ixImin2,ixImax1,ixImax2,&
      ixOmin1,ixOmin2,ixOmax1,ixOmax2, N2R)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2
    double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2, 1:2)
    double precision, intent(out)   :: N2R(ixImin1:ixImax1,ixImin2:ixImax2,&
        1:3)

    N2R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:3) = 1.0d0
    ...
    case (cylindrical)
      if ( z_ == 2 ) then
         N2R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3) = x(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2, 1)
      else
         N2R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2) = x(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2, 1)
      end if
    case (spherical)
      ! note: r_ = 1,theta_=2, phi_ = 3.
      N2R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2) = x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, 1)
      N2R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3) = x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, 1)  * dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 2))
    case default
      call mpistop("Sorry, coordinate unknown")
    end select
  ...
  subroutine partial_d(q,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    select case(coordinate)
    case(Cartesian)
      gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=0.5d0*(q(jxOmin1:jxOmax1,&
    ...
    case(spherical)
      ...
      case(2)
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=(q(jxOmin1:jxOmax1,&
           jxOmin2:jxOmax2)-q(hxOmin1:hxOmax1,&
           hxOmin2:hxOmax2))/(x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           2)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,2))
    ...
    case(cylindrical)
      if(idir==phi_) then
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=(q(jxOmin1:jxOmax1,&
           jxOmin2:jxOmax2)-q(hxOmin1:hxOmax1,&
           hxOmin2:hxOmax2))/(x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
           phi_)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,phi_)) !*x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,r_))
      else
        gradq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=(q(jxOmin1:jxOmax1,&
           jxOmin2:jxOmax2)-q(hxOmin1:hxOmax1,&
           hxOmin2:hxOmax2))/(x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
  ...
  subroutine covariant_dervitive(qvec,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,dqvec)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2
    double precision, intent(in)    :: qvec(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3)
    double precision, intent(inout) :: dqvec(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3,1:3)
    !double precision                :: x(ixI^S,1:ndim)
    double precision                :: chris(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3,1:3,1:3)
    integer                         :: jxOmin1,jxOmin2,jxOmax1,jxOmax2,&
        hxOmin1,hxOmin2,hxOmax1,hxOmax2
    ...
    case(Cartesian)
       ...
       do idir = 1, ndim
          do jdir = 1, 3
             ...
             jxOmin1=ixOmin1+kr(idir,1);jxOmin2=ixOmin2+kr(idir,2)
             jxOmax1=ixOmax1+kr(idir,1);jxOmax2=ixOmax2+kr(idir,2);
             dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                jdir)=0.5d0*(qvec(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                jdir)-qvec(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
                jdir))/dxlevel(idir)
          end do
       end do
    ...
    case(Cartesian_stretched)
       ...
       do idir = 1, ndim
          do jdir = 1, 3
             ...
             jxOmax1=ixOmax1+kr(idir,1);jxOmax2=ixOmax2+kr(idir,2);
             dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                jdir)=(qvec(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                jdir)-qvec(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
                jdir))/(x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                idir)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,idir))
          end do
       end do
     ...
     case(spherical)
       chris = 0.0d0
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1, 2, 2) = - x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1, 3, 3) = - x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)  * dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2))
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2, 1,&
           2) = 1.0d0 / x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1) 
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2, 2, 1) = chris(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,2, 1, 2)
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3, 3, 1) = chris(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,2, 1, 2)
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3, 1, 3) = chris(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,2, 1, 2)
        
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2, 3,&
           3) = - dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          2)) * dcos(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2)) 
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3, 2, 3) = dcos(x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,2)) / dsin(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2)) 
       chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3, 3, 2) = chris(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,3, 2, 3)
       ...
       do idir = 1, 3
          do jdir = 1, 3
             ...
             select case(idir)
             case(1)
               dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,&
                  idir)=(qvec(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                  jdir)-qvec(hxOmin1:hxOmax1,hxOmin2:hxOmax2,&
                  jdir))/((x(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
                  1)-x(hxOmin1:hxOmax1,hxOmin2:hxOmax2,1)))
             ...
             do kdir = 1, 3
                dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,&
                   idir)=dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,&
                   idir) + chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,idir,&
                   kdir)*qvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2, kdir)
             end do
          end do
       end do
    ...
    case(cylindrical)
       ...
       do idir = 1, 3
          do jdir = 1, 3
             ...
             do kdir = 1,3
                dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                   jdir)=dqvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                   jdir) + chris(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,idir,&
                   kdir)*qvec(ixOmin1:ixOmax1,ixOmin2:ixOmax2, kdir)
             end do
  ...
  subroutine gradientS(q,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    if (typegradlimiter/=limiter_ppm) then
      ...
      qL(ixCmin1:ixCmax1,ixCmin2:ixCmax2) = qL(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2) + 0.5d0*ldq(ixCmin1:ixCmax1,ixCmin2:ixCmax2)
      qR(ixCmin1:ixCmax1,ixCmin2:ixCmax2) = qR(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2) - 0.5d0*rdq(jxCmin1:jxCmax1,jxCmin2:jxCmax2)
    else
    ...
    if (slab_uniform) then
      do idims=1,ndim
        if (.not. use_4th_order) then
          ...
          divq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=divq(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2)+0.5d0*(qvec(jxOmin1:jxOmax1,jxOmin2:jxOmax2,&
      ...
      do idims=1,ndim
        ...
        if(stretched_dim(idims) .and. stretch_uncentered) then
          ...
          qC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)=block%surfaceC(ixCmin1:ixCmax1,&
             ixCmin2:ixCmax2,idims)*0.5d0*(qvec(ixCmin1:ixCmax1,&
             ixCmin2:ixCmax2,idims)+qvec(jxCmin1:jxCmax1,jxCmin2:jxCmax2,&
             idims))
        end if
        divq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=divq(ixOmin1:ixOmax1,&
  ...
  subroutine divvectorS(qvec,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    do idims=1,ndim
      ...
      if (slab_uniform) then
        divq(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=divq(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2)+0.5d0*(qR(ixOmin1:ixOmax1,&
      ...
      case(Cartesian) ! Cartesian grids
        ...
        do idir=idirmin0,3; do jdir=1,ndim; do kdir=1,ndir0
          if(lvc(idir,jdir,kdir)/=0)then
            ...
            tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=0.5d0*(tmp(jxOmin1:jxOmax1,&
