...
module mod_physics_roe
  ...
  abstract interface
     subroutine sub_average(wL, wR, x, ix^L, idim, wroe, workroe)
       ...
       double precision, intent(in)    :: wL(ixG^T, nprim), wR(ixG^T, nprim)
       double precision, intent(inout) :: wroe(ixG^T, nprim)
     ...
     subroutine sub_get_eigenjump(wL, wR, wC, x, ix^L, il, &
       ...
       double precision, dimension(ixG^T, nprim)       :: wL, wR, wC
     ...
     subroutine sub_rtimes(q, w, ix^L, iw, il, idim, rq, workroe)
       ...
       double precision, intent(in)    :: w(ixG^T, nprim), q(ixG^T)
