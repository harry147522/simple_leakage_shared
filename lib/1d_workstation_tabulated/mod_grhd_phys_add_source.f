...
contains
  ...
  subroutine grhd_add_source(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1, primCT,&
    ...
    do idir = 1, ndir
       u(ixOmin1:ixOmax1, idir) = primCT(ixOmin1:ixOmax1, W_vel(idir))
    end do
    do idir = 1, 3
       u(ixOmin1:ixOmax1, idir) = u(ixOmin1:ixOmax1,&
           idir) - lfac(ixOmin1:ixOmax1) * betai(ixOmin1:ixOmax1,&
  ...
  subroutine grhd_add_source_geom(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1,&
