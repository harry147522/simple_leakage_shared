...
contains
  ...
  subroutine rootfinding_brent(z, zmin, zmax, tolerance, iter_max, return_code, func)
    !> root
  ...
  subroutine rootfinding_illinois(z, zmin, zmax, tolerance, iter_max, return_code, func)
    !> root
    double precision, intent(out):: z
    !> the range of the root
    double precision, intent(in) :: zmin, zmax
