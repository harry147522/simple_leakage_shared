...
contains
  ...
  subroutine tvdlimit(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,idimmin,idimmax,s,qt,snew,fC,dx1,dx2,x)
    ...
    double precision, dimension(ixImin1:ixImax1,ixImin2:ixImax2,nprim) :: w,&
        wnew
    type(state) :: s, snew
    ...
    integer :: idims, ixICmin1,ixICmin2,ixICmax1,ixICmax2, jxICmin1,jxICmin2,&
       jxICmax1,jxICmax2
    double precision, dimension(ixImin1:ixImax1,ixImin2:ixImax2,nprim) :: wR,&
        wL

    associate(w=>s%prim,wnew=>snew%prim)
    do idims= idimmin,idimmax
       ...
       wL(ixICmin1:ixICmax1,ixICmin2:ixICmax2,1:nprim)=w(ixICmin1:ixICmax1,&
          ixICmin2:ixICmax2,1:nprim)
       jxICmin1=ixICmin1+kr(idims,1);jxICmin2=ixICmin2+kr(idims,2)
       jxICmax1=ixICmax1+kr(idims,1);jxICmax2=ixICmax2+kr(idims,2);
       wR(ixICmin1:ixICmax1,ixICmin2:ixICmax2,1:nprim)=w(jxICmin1:jxICmax1,&
          jxICmin2:jxICmax2,1:nprim)
  ...
  subroutine tvdlimit2(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixICmin1,&
    ...
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nprim) :: wL, wR
    double precision, intent(in) :: x(ixImin1:ixImax1,ixImin2:ixImax2,1:ndim)
    double precision :: wnew(ixImin1:ixImax1,ixImin2:ixImax2,1:nprim)
    double precision :: fC(ixImin1:ixImax1,ixImin2:ixImax2,1:ncons,1:ndim)

    double precision:: workroe(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nworkroe)
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nprim) :: wroeC
