...
111    close(unitpar)
  ...
  subroutine gremhd_update_eos(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
  ...
  subroutine gremhd_get_cmax(prim, x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    double precision                          :: gamma_hat(ixImin1:ixImax1,&
    ...
    lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1) = dsqrt( 1.0d0 / gamma_hat(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idim,&
        idim)) / prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2, psi_)**2
    lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2) = - lambda(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)
  ...
  subroutine gremhd_get_csound2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,prim,csound2)
    use mod_global_parameters
    use mod_eos
  ...
  subroutine gremhd_get_lfac2(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
  ...
  subroutine gremhd_get_tilde_S(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    call gremhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
        ...
        lfac=lfac(ixImin1:ixImax1,ixImin2:ixImax2), v2=v2(ixImin1:ixImax1,&
       ixImin2:ixImax2), E2=E2(ixImin1:ixImax1,ixImin2:ixImax2),&
        B2=B2(ixImin1:ixImax1,ixImin2:ixImax2), h=h(ixImin1:ixImax1,&
       ixImin2:ixImax2) )

    tilde_S(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = prim(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2, rho_) * h(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) * lfac(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) * v2(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) + 3.0d0 * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine gremhd_get_dt(w, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
  ...
  subroutine gremhd_check_prim(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, prim, flag)
    use mod_global_parameters
