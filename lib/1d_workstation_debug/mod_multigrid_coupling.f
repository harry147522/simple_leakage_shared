...
contains
  ...
  subroutine mg_copy_to_tree(iw_from, iw_to, restrict, restrict_gc, factor)
    ...
    do iigrid = 1, igridstail
       ...
       mg%boxes(id)%cc(0:nc+1, iw_to) = fac * ps(igrid)%prim(ixMlo1-1:ixMhi1+1,&
           iw_from)
...
!   end subroutine mg_copy_to_tree_gc
  ...
  subroutine mg_copy_from_tree(iw_from, iw_to)
    ...
    do iigrid = 1, igridstail
       ...
       ps(igrid)%prim(ixMlo1:ixMhi1, iw_to) = mg%boxes(id)%cc(1:nc, iw_from)
  ...
  subroutine mg_copy_from_tree_gc(iw_from, iw_to)
    ...
    do iigrid = 1, igridstail
       ...
       ps(igrid)%prim(ixMlo1-1:ixMhi1+1, iw_to) = mg%boxes(id)%cc(0:nc+1,&
           iw_from)
