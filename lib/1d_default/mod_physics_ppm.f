module mod_physics_ppm
  ...
  abstract interface
     subroutine sub_ppm_flatcd(rec_from,rec_to,ixImin1,ixImax1,ixOmin1,ixOmax1,&
        ixLmin1,ixLmax1,ixRmin1,ixRmax1,w,d2w,drho,dp)
...
contains
  ...
  subroutine dummy_ppm_flatcd(rec_from,rec_to,ixImin1,ixImax1,ixOmin1,ixOmax1,&
     ixLmin1,ixLmax1,ixRmin1,ixRmax1,w,d2w,drho,dp)
    use mod_global_parameters
    integer, intent(in)             :: rec_from,rec_to,ixImin1,ixImax1,ixOmin1,&
       ixOmax1,ixLmin1,ixLmax1,ixRmin1,ixRmax1
    double precision, intent(in)    :: w(ixImin1:ixImax1,1:nprim),&
       d2w(ixGlo1:ixGhi1,rec_from:rec_to)
    double precision, intent(inout) :: drho(ixImin1:ixImax1),&
       dp(ixImin1:ixImax1)
