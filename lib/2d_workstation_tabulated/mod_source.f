...
contains
  ...
  subroutine addsource1_grid(igrid,qdt,qt,w,src_active)
    ...
    double precision, intent(inout) :: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nprim)
    logical, intent(inout) :: src_active

    double precision :: w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nprim)
    ...
    w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nprim)=w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
       1:nprim)

    select case (typesourcesplit)
    case ('sf')
       call addsource2(qdt  ,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
          ixMhi2,1,nprim,qt,w1,qt,w,ps(igrid)%x,.true.,src_active)
    case ('sfs')
    ...
    case ('ssf')
       call addsource2(qdt/2,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixGlo1,ixGlo2,ixGhi1,&
          ixGhi2,1,nprim,qt,w,qt,w1,ps(igrid)%x,.true.,src_active)
       call addsource2(qdt  ,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
          ixMhi2,1,nprim,qt,w1,qt,w,ps(igrid)%x,.true.,src_active)
    case ('ssfss')
