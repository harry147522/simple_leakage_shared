...
contains
  ...
  subroutine grrhd_ppm_flatcd(rec_from, rec_to, ixI^L, ixO^L, ixL^L, ixR^L, w, d2w, drho, dp)
  ...
  subroutine grrhd_ppm_flatsh(ixI^L, ixO^L, ixLL^L, ixL^L, ixR^L, ixRR^L, idims, w, beta, z, dv)
    use mod_global_parameters
