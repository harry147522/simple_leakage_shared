...
module mod_eos
  ...
  procedure(sub_tabulated_logeps_to_logtemp), pointer  :: tabulated_logeps_to_logtemp      => null()
...
contains
  ...
  subroutine eos_atmo_activate()
    ...
    namelist /atmo_list/ atmo_gamma, atmo_adiab, &
                         small_rho, small_rho_fac, atmo_type
