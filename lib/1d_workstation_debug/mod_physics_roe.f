...
module mod_physics_roe
  ...
  abstract interface
     subroutine sub_average(wL, wR, x, ixmin1,ixmax1, idim, wroe, workroe)
       ...
       double precision, intent(in)    :: wL(ixGlo1:ixGhi1, nprim),&
           wR(ixGlo1:ixGhi1, nprim)
       double precision, intent(inout) :: wroe(ixGlo1:ixGhi1, nprim)
     ...
     subroutine sub_get_eigenjump(wL, wR, wC, x, ixmin1,ixmax1, il, idim,&
       ...
       double precision, dimension(ixGlo1:ixGhi1, nprim)       :: wL, wR, wC
