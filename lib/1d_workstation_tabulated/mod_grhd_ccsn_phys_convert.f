...
contains
  ...
  subroutine grhd_ccsn_to_conserved(ixImin1,ixImax1, ixOmin1,ixOmax1, cons,&
      prim, x)
    ...
    if ( fix_small_values ) then
       call grhd_ccsn_handle_small_values(prim(ixImin1:ixImax1, 1:nprim),&
           x(ixImin1:ixImax1, 1:ndim), ixImin1,ixImax1, ixOmin1,ixOmax1,&
           .True., 'grhd_ccsn_to_conserved')
    end if
  ...
  subroutine grhd_ccsn_to_primitive(ixImin1,ixImax1, ixOmin1,ixOmax1, cons,&
      prim, x)
    use mod_global_parameters
    use mod_geometry
