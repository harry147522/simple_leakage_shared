...
module mod_grhd_ccsn_ILEAS_ppm
  use mod_physics
  ...
  ! Public methods
  public :: grhd_ccsn_ILEAS_ppm_init

contains

  !> Initialize the module
  subroutine grhd_ccsn_ILEAS_ppm_init()
    use mod_physics_ppm

    phys_ppm_flatcd => grhd_ccsn_ILEAS_ppm_flatcd
    phys_ppm_flatsh => grhd_ccsn_ILEAS_ppm_flatsh
  end subroutine grhd_ccsn_ILEAS_ppm_init

  subroutine grhd_ccsn_ILEAS_ppm_flatcd(rec_from, rec_to, ixI^L, ixO^L, ixL^L, ixR^L, w, d2w, drho, dp)
  ...
  end subroutine grhd_ccsn_ILEAS_ppm_flatcd

  subroutine grhd_ccsn_ILEAS_ppm_flatsh(ixI^L, ixO^L, ixLL^L, ixL^L, ixR^L, ixRR^L, idims, w, beta, z, dv)
    use mod_global_parameters
  ...
  end subroutine grhd_ccsn_ILEAS_ppm_flatsh

end module mod_grhd_ccsn_ILEAS_ppm
