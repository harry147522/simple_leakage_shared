...
("Error: currently only IMEX schemes are supported when use radiation.")
  ...
  subroutine grrhd_update_eos(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
    ...
    do ix2 = ixOmin2,ixOmax2 
       call grrhd_update_eos_one_point(prim(ix1,ix2,:))
    enddo
    enddo
  end subroutine grrhd_update_eos

  !> Calculate cmax_idim within ixO^L
  subroutine grrhd_get_cmax(prim, x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
  ...
  subroutine grrhd_get_csound2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
  ...
  subroutine grrhd_get_lfac2(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
  ...
  subroutine grrhd_get_tilde_S(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
  ...
  subroutine grrhd_get_dt(w, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
  ...
  subroutine grrhd_check_prim(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
  ...
  subroutine grrhd_modify_wLR(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
    ...
    call grrhd_get_nu_zeta(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2, primL, s%x)
    call grrhd_get_nu_zeta(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2, primR, s%x)
