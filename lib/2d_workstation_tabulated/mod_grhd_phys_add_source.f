...
contains
  ...
  subroutine grhd_add_source(qdt, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    do idir = 1, ndir
       u(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = primCT(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, W_vel(idir))
    end do
    do idir = 1, 3
       u(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = u(ixOmin1:ixOmax1,&
  ...
  subroutine grhd_add_source_geom(qdt, ixImin1,ixImin2,ixImax1,ixImax2,&
