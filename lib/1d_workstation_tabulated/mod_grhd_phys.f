...
contains
  ...
  subroutine grhd_read_params(files)
    ...
    namelist /grhd_list/ evolve_hydro,  use_GR, tolerance, iter_max, lfac_max
...
111    close(unitpar)
  ...
  subroutine grhd_update_eos(ixImin1,ixImax1, ixOmin1,ixOmax1, prim)
    use mod_global_parameters
    use mod_eos
    ...
    do ix1 = ixOmin1,ixOmax1 
       call grhd_update_eos_one_point(prim(ix1,:))
    enddo
  end subroutine grhd_update_eos

  !> Calculate cmax_idim within ixO^L
  subroutine grhd_get_cmax(prim, x, ixImin1,ixImax1, ixOmin1,ixOmax1, idim,&
      cmax)
    use mod_global_parameters
    integer, intent(in)                       :: ixImin1,ixImax1, ixOmin1,&
       ixOmax1, idim
    ...
    call grhd_get_lambda(ixImin1,ixImax1, ixOmin1,ixOmax1, idim,&
  ...
  subroutine grhd_get_csound2(ixImin1,ixImax1,ixOmin1,ixOmax1,prim,csound2)
    use mod_global_parameters
    use mod_eos
  ...
  subroutine grhd_get_lfac2(ps_in,ixImin1,ixImax1,ixOmin1,ixOmax1,lfac2)
    use mod_global_parameters
  ...
  subroutine grhd_get_tilde_S(ps_in,ixImin1,ixImax1,ixOmin1,ixOmax1,tilde_S)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    type(state), intent(in)         :: ps_in
  ...
  subroutine grhd_get_dt(w, ixImin1,ixImax1, ixOmin1,ixOmax1, dtnew, dx1, x)
    use mod_global_parameters
  ...
  subroutine grhd_check_prim(ixImin1,ixImax1, ixOmin1,ixOmax1, prim, flag)
    use mod_global_parameters
    integer, intent(in)          :: ixImin1,ixImax1, ixOmin1,ixOmax1
