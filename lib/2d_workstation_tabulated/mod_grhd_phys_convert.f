...
contains
  ...
  subroutine grhd_to_conserved(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    if ( fix_small_values ) then
       call grhd_handle_small_values(prim(ixImin1:ixImax1,ixImin2:ixImax2,&
  ...
  subroutine grhd_to_primitive(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, cons, prim, x)
    use mod_global_parameters
    use mod_geometry
