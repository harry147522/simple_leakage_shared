module mod_grhd_ccsn_ILEAS_phys_parameters
  use mod_physics
  implicit none
  public
 ...
 ! double precision             :: lfac_max = 1.1d1
  ...
  subroutine grhd_ccsn_ILEAS_update_eos_one_point(prim)
...
!    call eos_get_cs2_one_grid(prim(cs2_),prim( rho_),prim( eps_), ye=prim( ye_))
  ...
  end subroutine grhd_ccsn_ILEAS_update_eos_one_point

  !> get some useful variables from primitive
  subroutine grhd_ccsn_ILEAS_get_intermediate_variables(ixI^L, ixO^L, prim, x, &
  ...
  end subroutine grhd_ccsn_ILEAS_get_intermediate_variables

  subroutine grhd_ccsn_ILEAS_get_lambda(ixI^L, ixO^L, idim, prim, x, lambda)
     use mod_global_parameters
  ...
  end subroutine grhd_ccsn_ILEAS_get_lambda

  !> This subroutine fix the abnormal values in conserved variables !
  subroutine grhd_ccsn_ILEAS_handle_small_values(prim, x, ixI^L, ixO^L, update_eos, subname)
    use mod_global_parameters
...
!             prim(ix^D, eps_) = max(small_eps, eps_min)
  ...
  end subroutine grhd_ccsn_ILEAS_handle_small_values

end module mod_grhd_ccsn_ILEAS_phys_parameters
