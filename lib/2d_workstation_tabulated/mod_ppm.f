...
contains
  ...
  subroutine PPMlimiter(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,ixmin1,&
     ixmin2,ixmax1,ixmax2,idims,w,wCT,wLC,wRC,fattening)
    ...
    double precision, intent(in)    :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:nprim),wCT(ixImin1:ixImax1,ixImin2:ixImax2,1:nprim)

    double precision, intent(inout) :: wRC(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
       1:nprim),wLC(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nprim) 
    logical, intent(in)             :: fattening

    double precision,dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
       rec_from:rec_to)  :: dwC,d2wC,ldw
    double precision,dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
       rec_from:rec_to)  :: wMin,wMax,tmp
    ...
    dwC(lxCmin1:lxCmax1,lxCmin2:lxCmax2,rec_from:rec_to)=w(lxRmin1:lxRmax1,&
       lxRmin2:lxRmax2,rec_from:rec_to)-w(lxCmin1:lxCmax1,lxCmin2:lxCmax2,&
       rec_from:rec_to)
    ! Eq. 64,  Miller and Colella 2002, JCP 183, 26 
    d2wC(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
       rec_from:rec_to)=half*(w(kxRmin1:kxRmax1,kxRmin2:kxRmax2,&
       rec_from:rec_to)-w(kxLmin1:kxLmax1,kxLmin2:kxLmax2,rec_from:rec_to))
    where(dwC(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
       rec_from:rec_to)*dwC(kxLmin1:kxLmax1,kxLmin2:kxLmax2,&
       rec_from:rec_to)>zero)
       ! Store the sign of dwC in wMin
       wMin(kxCmin1:kxCmax1,kxCmin2:kxCmax2,rec_from:rec_to)= sign(one,&
          d2wC(kxCmin1:kxCmax1,kxCmin2:kxCmax2,rec_from:rec_to))
       ! Eq. 65,  Miller and Colella 2002, JCP 183, 26 
       ldw(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
          rec_from:rec_to)= wMin(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
          rec_from:rec_to)*min(dabs(d2wC(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
          rec_from:rec_to)),2.0d0*dabs(dwC(kxLmin1:kxLmax1,kxLmin2:kxLmax2,&
          rec_from:rec_to)),2.0d0*dabs(dwC(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
          rec_from:rec_to)))
    elsewhere
       ldw(kxCmin1:kxCmax1,kxCmin2:kxCmax2,rec_from:rec_to)=zero
    endwhere

    ! Eq. 66,  Miller and Colella 2002, JCP 183, 26 
    wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to)=wLC(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rec_from:rec_to)+half*dwC(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rec_from:rec_to)+(ldw(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to)-ldw(ixRmin1:ixRmax1,ixRmin2:ixRmax2,&
       rec_from:rec_to))/6.0d0

    wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,rec_from:rec_to)=wRC(ixLmin1:ixLmax1,&
       ixLmin2:ixLmax2,rec_from:rec_to)-(half*dwC(ixLmin1:ixLmax1,&
       ixLmin2:ixLmax2,rec_from:rec_to)-(ldw(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
       rec_from:rec_to)-ldw(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to))/6.0d0)

    ! make sure that min wCT(i)<wLC(i)<wCT(i+1) same for wRC(i)
    call extremaw(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,kxCmin1,&
       kxCmin2,kxCmax1,kxCmax2,wCT,1,wMax,wMin)

    ! Eq. B8, page 217, Mignone et al 2005, ApJS
    wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,rec_from:rec_to)=max(wMin(&
       ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to),&
       min(wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to),&
       wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,rec_from:rec_to))) 
    wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to)=max(wMin(&
       ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to),&
       min(wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to),&
       wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to)))


    ! Eq. B9, page 217, Mignone et al 2005, ApJS
    where((wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
       rec_from:rec_to)-wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to))*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to)-wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to))<=zero)
       wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
          rec_from:rec_to)=wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          rec_from:rec_to)
       wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          rec_from:rec_to)=wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          rec_from:rec_to)
    end where

    wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to)=(wLC(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rec_from:rec_to)-wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
       rec_from:rec_to))*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to)-(wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       rec_from:rec_to)+wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
       rec_from:rec_to))/2.0d0)
    wMin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rec_from:rec_to)=(wLC(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rec_from:rec_to)-wRC(ixLmin1:ixLmax1,ixLmin2:ixLmax2,&
       rec_from:rec_to))**2.0d0/6.0d0
    tmp(ixLmin1:ixLmax1,ixLmin2:ixLmax2,rec_from:rec_to)=wRC(ixLmin1:ixLmax1,&
       ixLmin2:ixLmax2,rec_from:rec_to)
    ! Eq. B10, page 218, Mignone et al 2005, ApJS
    where(wMax(hxRmin1:hxRmax1,hxRmin2:hxRmax2,&
       rec_from:rec_to)>wMin(hxRmin1:hxRmax1,hxRmin2:hxRmax2,rec_from:rec_to))
       wRC(hxCmin1:hxCmax1,hxCmin2:hxCmax2,&
          rec_from:rec_to)= 3.0d0*wCT(hxRmin1:hxRmax1,hxRmin2:hxRmax2,&
          rec_from:rec_to)-2.0d0*wLC(hxRmin1:hxRmax1,hxRmin2:hxRmax2,&
          rec_from:rec_to)
    endwhere
    ! Eq. B11, page 218, Mignone et al 2005, ApJS
    where(wMax(hxCmin1:hxCmax1,hxCmin2:hxCmax2,&
       rec_from:rec_to)<-wMin(hxCmin1:hxCmax1,hxCmin2:hxCmax2,&
       rec_from:rec_to))
       wLC(hxCmin1:hxCmax1,hxCmin2:hxCmax2,&
          rec_from:rec_to)= 3.0d0*wCT(hxCmin1:hxCmax1,hxCmin2:hxCmax2,&
          rec_from:rec_to)-2.0d0*tmp(hxLmin1:hxLmax1,hxLmin2:hxLmax2,&
          rec_from:rec_to)
    endwhere
    ...
    if(flatcd.and.fattening)then
       ...
       call phys_ppm_flatcd(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,&
          kxCmin1,kxCmin2,kxCmax1,kxCmax2,kxLmin1,kxLmin2,kxLmax1,kxLmax2,&
          kxRmin1,kxRmin2,kxRmax1,kxRmax2,wCT,d2wC,aa,ab)
  ...
  subroutine extremaw(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,w,nshift,wMax,wMin)
    use mod_global_parameters
    ...
    double precision, intent(out) :: wMax(ixImin1:ixImax1,ixImin2:ixImax2,&
       rec_from:rec_to),wMin(ixImin1:ixImax1,ixImin2:ixImax2,rec_from:rec_to)
    ...
    do ishift=1,nshift
      ...
      if (ishift==1) then
        wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to)= max(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to),w(ixsRmin1:ixsRmax1,ixsRmin2:ixsRmax2,&
           rec_from:rec_to),w(ixsLmin1:ixsLmax1,ixsLmin2:ixsLmax2,&
           rec_from:rec_to))
        wMin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to)= min(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to),w(ixsRmin1:ixsRmax1,ixsRmin2:ixsRmax2,&
           rec_from:rec_to),w(ixsLmin1:ixsLmax1,ixsLmin2:ixsLmax2,&
           rec_from:rec_to))
      else
        wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to)= max(wMax(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to),w(ixsRmin1:ixsRmax1,ixsRmin2:ixsRmax2,&
           rec_from:rec_to),w(ixsLmin1:ixsLmax1,ixsLmin2:ixsLmax2,&
           rec_from:rec_to))
        wMin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to)= min(wMin(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           rec_from:rec_to),w(ixsRmin1:ixsRmax1,ixsRmin2:ixsRmax2,&
           rec_from:rec_to),w(ixsLmin1:ixsLmax1,ixsLmin2:ixsLmax2,&
           rec_from:rec_to))
      end if
