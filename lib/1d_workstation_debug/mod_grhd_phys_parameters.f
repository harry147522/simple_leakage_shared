module mod_grhd_phys_parameters
  ...
  subroutine grhd_get_intermediate_variables(ixImin1,ixImax1, ixOmin1,ixOmax1,&
      prim, x, gamma, lfac2, lfac, v2, h )
    use mod_global_parameters
    use mod_geometry
  ...
  subroutine grhd_get_lambda(ixImin1,ixImax1, ixOmin1,ixOmax1, idim, prim, x,&
      lambda)
     use mod_global_parameters
  ...
  subroutine grhd_handle_small_values(prim, x, ixImin1,ixImax1, ixOmin1,&
