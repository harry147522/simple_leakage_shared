module mod_grhd_ccsn_phys_one_d_core
  use mod_physics
  use mod_grhd_ccsn_phys_parameters, only: r_core, oneDcore

  implicit none
  private

  ! Public methods
  public :: grhd_ccsn_phys_one_d_core_init

contains

  !> Initialize the module
  subroutine grhd_ccsn_phys_one_d_core_init()
    use mod_usr_methods
    ...
    if ( oneDcore ) then
      usr_set_flux => grhd_ccsn_set_flux
      usr_internal_bc => grhd_ccsn_internal_bc
    end if
   

  end subroutine grhd_ccsn_phys_one_d_core_init

  
  !> 1D core treatment: internal_bc
  subroutine grhd_ccsn_internal_bc(level,qt,ixImin1,ixImin2,ixImax1,ixImax2,&
  ...
  end subroutine grhd_ccsn_internal_bc

  !> 1D core treatment: flux
  subroutine grhd_ccsn_set_flux(ixImin1,ixImin2,ixImax1,ixImax2,ixCmin1,&
     ixCmin2,ixCmax1,ixCmax2,idim,fC,xi)
    use mod_global_parameters
  ...
  end subroutine grhd_ccsn_set_flux
 

end module mod_grhd_ccsn_phys_one_d_core
