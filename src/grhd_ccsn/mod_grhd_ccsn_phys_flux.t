...
contains
  ...
  subroutine grhd_ccsn_get_cbounds(consL, consR, primL, primR, x, ixI^L, ixO^L, idim, cmax, cmin)
    ...
    call grhd_ccsn_get_lambda(ixI^L, ixO^L, idim, primL(ixI^S, 1:nprim), x(ixI^S, 1:ndim), lambdaL(ixI^S,1:2))
    call grhd_ccsn_get_lambda(ixI^L, ixO^L, idim, primR(ixI^S, 1:nprim), x(ixI^S, 1:ndim), lambdaR(ixI^S,1:2))
  ...
  subroutine grhd_ccsn_get_flux(cons, prim, x, ixI^L, ixO^L, idim, f)
    use mod_global_parameters
