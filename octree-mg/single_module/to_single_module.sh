...
module_1d="m_octree_mg_1d.t"
module_2d="m_octree_mg_2d.t"
module_3d="m_octree_mg_3d.t"
newline=$'\n'
header=""
code=""
...
# Generate 1D, 2D and 3D versions
gfortran -E -cpp -P -DNDIM=1 "$module_xd" -o "$module_1d"
echo "Generated $module_1d"
