...
module mod_usr_methods
  ...
  ! Non-paralleled subroutine
  procedure(nompi), pointer          :: usr_nompi           => null()
  ...
  ! for some subroutine which cannot/hard be paralleled, e.g. leakage with
  ! abosrption / ILEAS
    subroutine nompi(iit, qt)
      use mod_global_parameters
      integer, intent(in)          :: iit
      double precision, intent(in) :: qt
    end subroutine nompi
    ...
    subroutine aux_output(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ...
      double precision             :: w(ixImin1:ixImax1,ixImin2:ixImax2,nprim)
    ...
    subroutine source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,iwmin,iwmax,qtC,primCT,qt,cons,x)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
    ...
    subroutine get_resistivity(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,cons,x,eta)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
          ixOmin1,ixOmin2,ixOmax1,ixOmax2
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
      ...
      double precision, intent(in)    :: cons(ixImin1:ixImax1,ixImin2:ixImax2,&
         1:ncons)
      double precision, intent(out)   :: eta(ixImin1:ixImax1,ixImin2:ixImax2)
    ...
    subroutine get_opacities(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,cons,prim,x, var_out)
      use mod_global_parameters
      integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
          ixOmin1,ixOmin2,ixOmax1,ixOmax2
      double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
      ...
      double precision, intent(in)    :: prim(ixImin1:ixImax1,ixImin2:ixImax2,&
         1:nprim)
      double precision, intent(out)   :: var_out(ixImin1:ixImax1,&
         ixImin2:ixImax2,1:3)
