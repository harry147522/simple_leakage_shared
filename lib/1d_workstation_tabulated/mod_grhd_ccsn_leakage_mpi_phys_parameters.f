...
!    call eos_get_cs2_one_grid(prim(cs2_),prim( rho_),prim( eps_), ye=prim( ye_))
  ...
  subroutine grhd_ccsn_leakage_mpi_get_intermediate_variables(ixImin1,ixImax1,&
  ...
  subroutine grhd_ccsn_leakage_mpi_get_lambda(ixImin1,ixImax1, ixOmin1,ixOmax1,&
      idim, prim, x, lambda)
     use mod_global_parameters
  ...
  subroutine grhd_ccsn_leakage_mpi_handle_small_values(prim, x, ixImin1,&
     ixImax1, ixOmin1,ixOmax1, update_eos, subname)
    use mod_global_parameters
