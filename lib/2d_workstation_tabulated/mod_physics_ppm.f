module mod_physics_ppm
  ...
  abstract interface
     subroutine sub_ppm_flatcd(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,&
...
contains
  ...
  subroutine dummy_ppm_flatcd(rec_from,rec_to,ixImin1,ixImin2,ixImax1,ixImax2,&
     ixOmin1,ixOmin2,ixOmax1,ixOmax2,ixLmin1,ixLmin2,ixLmax1,ixLmax2,ixRmin1,&
     ixRmin2,ixRmax1,ixRmax2,w,d2w,drho,dp)
    use mod_global_parameters
    integer, intent(in)             :: rec_from,rec_to,ixImin1,ixImin2,ixImax1,&
