...
module mod_grrhd_ppm
  ...
  ! Public methods
  public :: grrhd_ppm_init

contains

  !> Initialize the module
  subroutine grrhd_ppm_init()
    use mod_physics_ppm

    phys_ppm_flatcd => grrhd_ppm_flatcd
    phys_ppm_flatsh => grrhd_ppm_flatsh
  end subroutine grrhd_ppm_init

  subroutine grrhd_ppm_flatcd(rec_from, rec_to, ixImin1,ixImax1, ixOmin1,&
  ...
  end subroutine grrhd_ppm_flatcd

  subroutine grrhd_ppm_flatsh(ixImin1,ixImax1, ixOmin1,ixOmax1, ixLLmin1,&
  ...
  end subroutine grrhd_ppm_flatsh

end module mod_grrhd_ppm
