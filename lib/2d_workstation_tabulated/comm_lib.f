...
subroutine init_comm_types
  ...
  size_block=nxG1*nxG2*nprim*size_double
  ...
  if(stagger_grid) then
    ...
    size_block_io_stg=(nx1+1)*(nx2+1)*nprims*size_double
  ...
  size_block_io=nx1*nx2*nprim*size_double
...
!> Exit MPI-GMUNU with an error message
