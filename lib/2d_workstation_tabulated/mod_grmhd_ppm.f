...
contains
  ...
  subroutine grmhd_ppm_flatcd(rec_from, rec_to, ixImin1,ixImin2,ixImax1,&
  ...
  subroutine grmhd_ppm_flatsh(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
     ...
     ixRRmax1,ixRRmax2, idims, w, beta, z, dv)
    use mod_global_parameters
