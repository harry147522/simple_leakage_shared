...
contains
  ...
  subroutine gremhd_evaluate_implicit(qtC,psa)
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       call phys_to_primitive(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
          ixMhi2,psa(igrid)%cons(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ncons),&
          psa(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nprim),&
    ...
    !$OMP PARALLEL DO PRIVATE(igrid)
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       call gremhd_get_stiff_source(qtC,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,&
          ixMlo2,ixMhi1,ixMhi2, psa(igrid)%cons(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
  ...
  subroutine gremhd_implicit_update(dtfactor,qdt,qtC,psa,psb)
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       call gremhd_implicit_update_grid(dtfactor,qdt,qtC,ixGlo1,ixGlo2,ixGhi1,&
          ixGhi2,ixMlo1,ixMlo2,ixMhi1,ixMhi2, psa(igrid)%cons(ixGlo1:ixGhi1,&
          ixGlo2:ixGhi2,1:ncons),psa(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
          1:nprim),psa(igrid)%x(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndim))
    end do
    !$OMP END PARALLEL DO
  end subroutine gremhd_implicit_update

  subroutine gremhd_get_stiff_source(qtC,ixImin1,ixImin2,ixImax1,ixImax2,&
      ixOmin1,ixOmin2,ixOmax1,ixOmax2, cons, prim, x)
    use mod_global_parameters
    use mod_usr_methods
    double precision, intent(in)    :: qtC !< Both states psa and psb at this time level
    ...
    double precision                :: eta(ixImin1:ixImax1,ixImin2:ixImax2) !resistivity
    double precision                :: xi(ixImin1:ixImax1,ixImin2:ixImax2) !proper dynamo action term
    double precision                :: qE_dot_v(ixImin1:ixImax1,&
       ixImin2:ixImax2), qB_dot_v(ixImin1:ixImax1,ixImin2:ixImax2) 
    double precision                :: gamma(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3,1:3)
    double precision                :: sqrt_gamma(ixImin1:ixImax1,&
       ixImin2:ixImax2)
    double precision                :: qJi(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3) !conformally transformed Current, but only the stiff part
    integer                         :: idir, jdir, kdir

    call usr_get_resistivity(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2, cons(ixImin1:ixImax1,ixImin2:ixImax2, 1:ncons),&
        x(ixImin1:ixImax1,ixImin2:ixImax2, 1:ndim), eta(ixImin1:ixImax1,&
       ixImin2:ixImax2))
    if (associated(usr_get_dynamo_coeff)) then
       call usr_get_dynamo_coeff(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
          ixOmin2,ixOmax1,ixOmax2, cons(ixImin1:ixImax1,ixImin2:ixImax2,&
           1:ncons), x(ixImin1:ixImax1,ixImin2:ixImax2, 1:ndim),&
           xi(ixImin1:ixImax1,ixImin2:ixImax2))
    else
       xi(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0 ! no dynamo at the moment
    end if
    ...
    qE_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0
    do idir = 1, ndir
       qE_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = qE_dot_v(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) + cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Econs(idir)) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           W_vel(idir)) * gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir, idir)
    end do
    qE_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = qE_dot_v(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) / lfac(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    qB_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0
    do idir = 1, ndir
       qB_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = qB_dot_v(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) + cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    ! dynamo part
    do idir = 1, ndir
       qJi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = lfac(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Bcons(idir)) - qB_dot_v(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           W_vel(idir))
       do jdir = 1, ndir
          do kdir = 1, ndir
             qJi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = qJi(ixOmin1:ixOmax1,&
                ixOmin2:ixOmax2, idir) - lvc(idir, jdir,&
                 kdir) / gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir,&
                 idir) * sqrt_gamma(ixOmin1:ixOmax1,&
                ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                 W_vel(jdir)) * cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                 Econs(kdir))
          end do
       end do
    end do
    do idir = 1, ndir
       qJi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = -xi(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * qJi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir)
    end do

    do idir = 1, ndir
       qJi(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = qJi(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, idir) + lfac(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Econs(idir)) - qE_dot_v(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           W_vel(idir))
       do jdir = 1, ndir
          do kdir = 1, ndir
    ...
    cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1:ncons) = 0.0d0
    do idir = 1, ndir
       cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Econs(idir)) = - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           alp_) / eta(ixOmin1:ixOmax1,ixOmin2:ixOmax2) * qJi(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, idir)
    end do
  end subroutine gremhd_get_stiff_source

  subroutine gremhd_implicit_update_grid(dtfactor,qdt,qtC,ixImin1,ixImin2,&
     ixImax1,ixImax2, ixOmin1,ixOmin2,ixOmax1,ixOmax2, cons, prim, x)
    use mod_global_parameters
    use mod_usr_methods
    use mod_geometry
    use mod_eos
    ...
    call get_sqrt_gamma_hat(x(ixImin1:ixImax1,ixImin2:ixImax2, 1:ndim),&
        ...
        sqrt_gamma(ixImin1:ixImax1,ixImin2:ixImax2))
    sqrt_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = psi6(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) * sqrt_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    ...
    do ix2 = ixOmin2,ixOmax2 
      ! get sigma_L
      sigma_L = dtfactor * qdt * prim(ix1,ix2, alp_) !sigma_L = alpha * delta_t
      eta_tilde = eta(ix1,ix2) / sigma_L
      if ( (cons_tmp(ix1,ix2, D_) <= small_D) .or. (cons_tmp(ix1,ix2,&
         ...
         ! initial guess of ui
         do idir = 1, ndir
            ui_hat(idir) = prim(ix1,ix2, W_vel(idir))
         end do
         ...
         case (1) ! failed to find the root
            if (debug_flag) then
               write(*,*) 'location x =',x(ix1,ix2, 1:ndim)
               write(*,*) 'rho =', prim(ix1,ix2, rho_), small_rho
               write(*,*) 'D = ', cons(ix1,ix2, D_), cons_tmp(ix1,ix2, D_),&
                   small_rho_thr
               write(*,*) 'D_atmo/D = ', small_D/cons(ix1,ix2, D_)
               write(*,*) 'Wv = ', prim(ix1,ix2, W_vel(:))
               write(*,*) 'ui = ', ui_hat(1:ndir)
               write(*,*) 'f(Wv) = ', func_of_u(prim(ix1,ix2, W_vel(:)))
               write(*,*) 'f = ', func_of_u(ui_hat)
               write(*,*) 'eta =',eta(ix1,ix2), eta_tilde
               write(*,*) 'sigma =',1.0d0/eta(ix1,ix2)
               write(*,*) 'cons = ', cons(ix1,ix2, 1:ncons)
               call mpistop&
...
("Error: slope is larger or equals to zero in gremhd_implicit_update")
      ...
      if ( cons_tmp(ix1,ix2, D_) / lfac <= small_rho_thr ) then
    ...
    do idir = 1, ndir
       cons(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Econs(idir)) = cons_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           Econs(idir)) * psi6(ixOmin1:ixOmax1,ixOmin2:ixOmax2) 
    end do
    ...
    contains
       ...
       subroutine get_vars(ui_in, W_out, E_out, f_out, fjac_out)
          ...
          W_hat = 1.0d0
          do idir = 1, ndir
             W_hat = W_hat + ui_in(idir)**2 * gamma(ix1,ix2, idir, idir)
          end do
          W_hat = dsqrt( W_hat )
          ...
          ! get E field from u
          coeff_A(0) = W_hat + eta_tilde + xi(ix1,&
             ix2)**2 * ( W_hat**2 - 1.0d0 ) / ( W_hat + eta_tilde ) 
          coeff_A(1) = ( 1.0d0 + xi(ix1,ix2)**2 * W_hat / ( W_hat + eta_tilde &
             ) ) * eta_tilde / ( 1.0d0 + W_hat * eta_tilde )
          coeff_A(2) = - xi(ix1,ix2) * eta_tilde / ( W_hat + eta_tilde )
          coeff_A(3) = xi(ix1,ix2) * ( 1.0d0 + eta_tilde * W_hat ) / ( W_hat + &
             eta_tilde )
          coeff_A(4) = xi(ix1,ix2) * ( 1.0d0 - eta_tilde**2 + xi(ix1,&
             ix2)**2 ) / ( W_hat + eta_tilde ) / ( 1.0d0 + W_hat * eta_tilde )
          coeff_A(5) = - 1.0d0 - ( xi(ix1,&
             ix2)**2 * W_hat ) / ( W_hat + eta_tilde )

          E_dot_u = 0.0d0
          B_dot_u = 0.0d0
          do idir = 1, ndir
             E_dot_u = E_dot_u + cons_tmp(ix1,ix2,&
                 Econs(idir)) * ui(idir) * gamma(ix1,ix2, idir, idir)
             B_dot_u = B_dot_u + cons_tmp(ix1,ix2,&
                 Bcons(idir)) * ui(idir) * gamma(ix1,ix2, idir, idir)
          end do
          
          do idir = 1, ndir
             E_field(idir) = eta_tilde * cons_tmp(ix1,ix2,&
                 Econs(idir)) + coeff_A(1) * E_dot_u * ui(idir) + coeff_A(3) * &
                cons_tmp(ix1,ix2, Bcons(idir)) + coeff_A(4) * B_dot_u * &
                ui(idir) 
             do jdir = 1, ndir
                do kdir = 1, ndir
                   E_field(idir) = E_field(idir) + lvc(idir,jdir,&
                      kdir) / sqrt_gamma(ix1,ix2) * ui(jdir) * gamma(ix1,ix2,&
                       jdir, jdir) * gamma(ix1,ix2, kdir,&
                       kdir) * ( coeff_A(2) * cons_tmp(ix1,ix2,&
                       Econs(kdir)) + coeff_A(5) * cons_tmp(ix1,ix2,&
                       Bcons(kdir)) ) 
                end do
             end do
          end do
          ...
          if (present(f_out).or.present(fjac_out)) then
             ...
             fluid_energy = 0.0d0
             do idir = 1, ndir
                fluid_energy = fluid_energy + gamma(ix1,ix2, idir,&
                    idir) * ( E_field(idir)**2 + cons_tmp(ix1,ix2,&
                    Bcons(idir))**2 )
             end do
             fluid_energy = cons_tmp(ix1,ix2,&
                 tau_) - 0.5d0 * fluid_energy + cons_tmp(ix1,ix2, D_)
   
             ! modified enthalpy
             hD = ( W_hat * fluid_energy - one_over_eos_gamma_1 * cons_tmp(ix1,&
                ix2, D_) ) / ( W_hat**2 - one_over_eos_gamma_1 ) 

             ! S_i_prime = S_i - EM part
             do idir = 1, ndir
                S_i_prime(idir) = cons_tmp(ix1,ix2, mom(idir))
                do jdir = 1, ndir
                   do kdir = 1, ndir
                      S_i_prime(idir) = S_i_prime(idir) - sqrt_gamma(ix1,&
                         ix2) * lvc(idir,jdir,&
                         kdir) * E_field(jdir) * cons_tmp(ix1,ix2,&
                          Bcons(kdir))
                   end do
                end do
             end do
             ...
             if (present(fjac_out)) then 
                ! get dEdu
                coeff_A_dot(0) = 1.0d0 + xi(ix1,&
                   ix2)**2 * ( 1.0d0 + W_hat**2 + 2.0d0 * eta_tilde * W_hat ) &
                   / ( W_hat + eta_tilde )**2
                coeff_A_dot(1) = - eta_tilde**2 / ( 1.0d0 + W_hat * eta_tilde &
                   )**2 * ( 1.0d0 + xi(ix1,&
                   ix2)**2 * ( W_hat**2 - 1.0d0 )**2 / ( W_hat + eta_tilde &
                   )**2 )
                coeff_A_dot(2) = xi(ix1,ix2) * eta_tilde / ( W_hat + eta_tilde &
                   )**2
                coeff_A_dot(3) = xi(ix1,ix2) * ( eta_tilde**2 - 1.0d0 ) / ( &
                   W_hat + eta_tilde )**2
                coeff_A_dot(4) = - xi(ix1,&
                   ix2) * ( 1.0d0 - eta_tilde**2 + xi(ix1,&
                   ix2)**2 ) * ( 1.0d0 + eta_tilde**2 + 2.0d0 * eta_tilde * &
                   W_hat) / ( W_hat + eta_tilde )**2 / ( 1.0d0 + W_hat * &
                   eta_tilde )**2 
                coeff_A_dot(5) = - xi(ix1,&
                   ix2)**2 * eta_tilde / ( W_hat + eta_tilde )**2
                ...
                do adir = 1, ndir
                   do bdir = 1, ndir
                      ...
                      dEdu(adir, bdir) = ( - coeff_A_dot(0) * E_field(adir) + &
                         coeff_A_dot(3) * cons_tmp(ix1,ix2,&
                          Bcons(adir)) ) * ui(bdir) * gamma(ix1,ix2, bdir,&
                          bdir) + W_hat * ui(adir) * ( coeff_A(1) * &
                         cons_tmp(ix1,ix2,&
                          Econs(bdir)) + coeff_A(4) * cons_tmp(ix1,ix2,&
                          Bcons(bdir)) ) * gamma(ix1,ix2, bdir,&
                         ...
                         gamma(ix1,ix2, bdir, bdir) )
                      do jdir = 1, ndir
                         do kdir = 1, ndir
                            dEdu(adir, bdir) = dEdu(adir, bdir) + lvc(adir,&
                               jdir,kdir) / sqrt_gamma(ix1,ix2) * gamma(ix1,&
                               ix2, kdir, kdir)  * ( cons_tmp(ix1,ix2,&
                                Bcons(kdir)) * ( coeff_A(5) * W_hat * &
                               gamma(ix1,ix2, jdir,&
                                bdir) + coeff_A_dot(5) * ui(jdir) * ui(adir) * &
                               gamma(ix1,ix2, jdir, jdir) * gamma(ix1,ix2,&
                                adir, adir)) + cons_tmp(ix1,ix2,&
                ...
                do jdir = 1, ndir
                   dhDdu(jdir) = ( fluid_energy / W_hat - 2.0d0 * hD ) * &
                      ui(jdir) * gamma(ix1,ix2, jdir, jdir)
                   do idir = 1, ndir
                      dhDdu(jdir) = dhDdu(jdir) - W_hat * E_field(idir) * &
                         gamma(ix1,ix2, idir, idir) * dEdu(idir, jdir)
                   end do
                end do
                ...
                do idir = 1, ndir
                   do jdir = 1, ndir
                      ...
                      fjac_out(idir, jdir) = gamma(ix1,ix2, idir,&
                          jdir) + S_i_prime(idir) / hD**2 * dhDdu(jdir)

                      do adir = 1, ndir
                         do bdir = 1, ndir
                            fjac_out(idir, jdir) = fjac_out(idir,&
                                jdir) + sqrt_gamma(ix1,ix2) / hD * lvc(idir,&
                               adir,bdir) * dEdu(adir, jdir) * cons_tmp(ix1,&
                               ix2, Bcons(bdir))
                         end do
                      end do
       ...
       function fmin_of_f(ui) result (f)
          ...
          f = 0.0d0
          do idir=1, ndir
             f = f + fvec(idir)**2 / gamma(ix1,ix2, idir, idir)
          end do
