...
!    end if
  ...
  subroutine cfc_metric_init()
    ...
    allocate(Aij(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:3,1:3,1:igridstail))
    allocate(A2(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:igridstail))
    Aij = 0.0d0
    A2 = 0.0d0
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       ps(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           psi_) = max( ps(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2, psi_),&
           1.0d0 )
       ps(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           alp_) = min( max( ps(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2, alp_),&
           0.0d0 ), 1.0d0)
    end do
    !$OMP END PARALLEL DO
    ...
    do mg_it = 1, mg_it_max
       ...
       do iigrid=1,igridstail; igrid=igrids(iigrid)
          ! copy psi
          ps1(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
              psi_) = ps(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2, psi_)
          ! get the new conserved variables with current psi
          call phys_to_conserved(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,&
       ...
       call cfc_solve_beta(.False.,Aij(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:3,1:3,&
          1:igridstail))
       !$OMP PARALLEL DO PRIVATE(igrid)
       do iigrid = 1, igridstail;  igrid = igrids(iigrid);
          ...
          call cfc_get_Aij_grid(ps(igrid), ixGlo1,ixGlo2,ixGhi1,ixGhi2, ixMlo1,&
             ixMlo2,ixMhi1,ixMhi2, A2(ixGlo1:ixGhi1,ixGlo2:ixGhi2,iigrid),&
              Aij(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:3,1:3,iigrid))
       end do
       !$OMP END PARALLEL DO
       call cfc_solve_psi(A2(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:igridstail))
       ...
       do iigrid=1,igridstail; igrid=igrids(iigrid)
          local_err = max( local_err, maxval( dabs( &
             (ps(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
              psi_) - ps1(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
              psi_) ) /ps1(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
              psi_) ) ) )
       end do
       !$OMP END PARALLEL DO
    ...
    call cfc_solve_alp(A2(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:igridstail))
    call cfc_solve_beta(.True., Aij(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:3,1:3,&
       1:igridstail))
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid)
       psi_xns_err_local = maxval(dabs((ps(igrid)%prim(ixMlo1:ixMhi1,&
          ixMlo2:ixMhi2, psi_) - pso(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
           psi_) ) /pso(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2, psi_) ))
       alp_xns_err_local = maxval(dabs((ps(igrid)%prim(ixMlo1:ixMhi1,&
          ixMlo2:ixMhi2, alp_) - pso(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
           alp_) ) /pso(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2, alp_) ))
    end do
    !$OMP END PARALLEL DO
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       ps(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
          nhydro_lo:nhydro_hi) = pso(igrid)%prim(ixMlo1:ixMhi1,ixMlo2:ixMhi2,&
          nhydro_lo:nhydro_hi)
    end do
    !$OMP END PARALLEL DO
  ...
  subroutine cfc_solve_metric()
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       call phys_to_primitive(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
          ixMhi2,ps(igrid)%cons(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ncons),&
          ps(igrid)%prim(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nprim),&
          ps(igrid)%x(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndim))
    end do
    !$OMP END PARALLEL DO
  ...
  subroutine cfc_get_Aij_grid( ps_in, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, A2, Aij)
    use mod_global_parameters
    use mod_geometry
    ...
    double precision, intent(out)   :: A2(ixImin1:ixImax1,ixImin2:ixImax2)
    double precision, intent(out)   :: Aij(ixImin1:ixImax1,ixImin2:ixImax2,1:3,&
       1:3)

    integer                         :: jxOmin1,jxOmin2,jxOmax1,jxOmax2,&
        hxOmin1,hxOmin2,hxOmax1,hxOmax2
    integer                         :: idir, jdir, kdir, ldir
    double precision                :: fij(ixImin1:ixImax1,ixImin2:ixImax2,&
        1:3, 1:3)
    double precision                :: dvecX(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:3,1:3)
    ...
    do idir = 1, ndim
       do jdir = 1, ndir
          call partial_d( prim(ixImin1:ixImax1,ixImin2:ixImax2,vecX(jdir)),&
              ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,ixOmax1,ixOmax2,&
              idir, dvecX(ixImin1:ixImax1,ixImin2:ixImax2, jdir, idir))
       end do
    end do
    ...
    case (cartesian)
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1,&
          1) = 2.0d0/3.0d0 * ( 2.0d0 * dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1)  - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2)  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 2,&
          2) = 2.0d0/3.0d0 * ( - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1)  + 2.0d0 * dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2)  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 3,&
          3) = 2.0d0/3.0d0 * ( - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1)  - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2)  )
    case (cylindrical)
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1,&
          1) = 2.0d0/3.0d0 * ( 2.0d0 * dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(1))/x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)  - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2)  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 2,&
          2) = 2.0d0/3.0d0 * ( -dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(1))/x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)  + 2.0d0 * dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          2,2)  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 3,&
          3) = 2.0d0/3.0d0/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,&
          3) * ( -dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1) + 2.0d0 * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          vecX(1))/x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          1)  - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,2)  )
    case (spherical)
       ...
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1,&
          1) = 2.0d0/3.0d0 * ( 2.0d0 * ( dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          1,1) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          vecX(1))/x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          1) ) - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,&
          2) - cot_theta(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(2))  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 2,&
          2) = 2.0d0/3.0d0/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,&
          2) * ( -dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1) + prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(1))/x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)  + 2.0d0 * dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          2,2) - cot_theta(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(2))  )
       Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 3,&
          3) = 2.0d0/3.0d0/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,&
          3) * ( -dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1,&
          1) + prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(1))/x(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2,1)  - dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,&
          2) + 2.0d0 * cot_theta(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,vecX(2))  )
   
    end select
    
    Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1,2) =  dvecX(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1,2)/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,&
       2) + dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,1) 
    Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 1,3) =  dvecX(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,3,1)                + dvecX(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1,3)/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3,3)
    Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, 2,3) =  dvecX(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,3,2)/fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,&
       2) + dvecX(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2,3)/fij(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,3,3)
    do idir = 1, 2
       do jdir = idir+1, 3
          Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, jdir,&
              idir) = Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir, jdir) 
       end do
    end do
    ...
    do jdir = 1, 3; do idir = 1, 3
       do kdir = 1, 3
          do ldir = 1, 3
             A2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = A2(ixOmin1:ixOmax1,&
                ixOmin2:ixOmax2) + fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                kdir) * fij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,jdir,&
                ldir) * Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir,&
                jdir) * Aij(ixOmin1:ixOmax1,ixOmin2:ixOmax2,kdir,ldir) 
          end do
       end do
    end do; end do
  ...
  subroutine cfc_metric_interpolation(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,idims,prim,x,primi,xi)
    use mod_global_parameters
    use mod_physics
       ...
       case (1)
          do ix2 = ixOmin2, ixOmax2
             do ix1 = ixOmin1, ixOmax1
                ...
                call lagrange_interpolation(xx,yy,xi(ix1, ix2, 1), primi(ix1,&
                    ix2, iw))
             end do
          end do
       case (2)
          do ix1 = ixOmin1, ixOmax1
             do ix2 = ixOmin2, ixOmax2
                ...
                call lagrange_interpolation(xx,yy,xi(ix1, ix2, 2), primi(ix1,&
                    ix2, iw))
             end do
          end do
       case default
