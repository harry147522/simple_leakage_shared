module mod_grmhd_phys_parameters
  ...
  subroutine grmhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
      ixOmin1,ixOmin2,ixOmax1,ixOmax2, prim, x, gamma, lfac2, lfac, v2, v_hat,&
      b2, B_dot_v, Bvec2, bmu, Ptot, htot )
    use mod_global_parameters
    use mod_physics
    use mod_geometry
    ...
    double precision, intent(out), optional :: htot(ixImin1:ixImax1,&
       ixImin2:ixImax2) !modified enthalpy:(h + b2/rho)
    double precision, intent(out), optional :: Ptot(ixImin1:ixImax1,&
       ixImin2:ixImax2) !total pressure

    integer                                 :: idir
    double precision                        :: B_dot_v_tmp(ixImin1:ixImax1,&
       ixImin2:ixImax2)   
    double precision                        :: bmu_tmp(ixImin1:ixImax1,&
       ixImin2:ixImax2,0:ndir) !projection of Bmu,Bmu along fluid four-velocity unu,unu
    ...
    do idir = 1, ndir
       v_hat_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir) = prim(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, alp_) * prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           W_vel(idir)) / lfac_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2, beta(idir))
    end do
    if ( present(v_hat) ) v_hat(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1:ndir) = v_hat_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:ndir)

    B_dot_v_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0
    do idir = 1, ndir
       B_dot_v_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = &
          B_dot_v_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) + prim(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2, Bvec(idir)) * gamma_tmp(ixOmin1:ixOmax1,&
    ...
    if ( present(B_dot_v) ) then
       B_dot_v(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = B_dot_v_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2)
    end if

    b2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0
    do idir = 1, ndir
       b2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = b2_tmp(ixOmin1:ixOmax1,&
    ...
    if ( present(Bvec2) ) then
       Bvec2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = b2_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2)
    end if
    b2_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = b2_tmp(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) / lfac2_tmp(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) + B_dot_v_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)**2
    if ( present(b2) ) then
       b2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = b2_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2)
    end if

    if ( present(bmu) ) then
       ! Calculate the projection of B^mu along fluid four-velocity u^nu
       bmu(ixOmin1:ixOmax1,ixOmin2:ixOmax2,0) = B_dot_v_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) * lfac_tmp(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2) / prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2, alp_)
       do idir = 1, ndir
          bmu(ixOmin1:ixOmax1,ixOmin2:ixOmax2,idir) = prim(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2, Bvec(idir)) / lfac_tmp(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2) + bmu(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             0) * v_hat_tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idir)
       end do
    end if
  ...
  subroutine grmhd_get_lambda(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
     ...
     double precision                :: cs2(ixImin1:ixImax1,ixImin2:ixImax2),&
         ca2(ixImin1:ixImax1,ixImin2:ixImax2)
     ...
     double precision                :: a2(ixImin1:ixImax1,ixImin2:ixImax2) !upper bound for the fast wave speed
    ...
    call grmhd_get_intermediate_variables(ixImin1,ixImin2,ixImax1,ixImax2,&
       ...
       ixImin2:ixImax2), b2=b2(ixImin1:ixImax1,ixImin2:ixImax2),&
        htot=htot(ixImin1:ixImax1,ixImin2:ixImax2) )
     ...
     ca2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) =  b2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) / ( prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         rho_) * htot(ixOmin1:ixOmax1,ixOmin2:ixOmax2) )
 
     ! upper bound for the fast wave speed
     a2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = cs2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) + ca2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) - ca2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) * cs2(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
 
     tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = ( 1.0d0 - a2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) ) * vel(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idim) 
     tmp2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( a2(ixOmin1:ixOmax1,&
        ...
        idim) - ( 1.0d0 - a2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) ) * vel(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idim)**2 ) )

     lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1) = ( tmp1(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) + tmp2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) ) / ( 1.0d0 - v2(ixOmin1:ixOmax1,&
        ixOmin2:ixOmax2) * a2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) ) 
     ...
     clight(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( 1.0d0 / &
     ...
     if (type_divb == divb_glm) then
        ...
        tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = dsqrt( 1.0d0 / &
           gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2, idim,&
            idim) - prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           beta(idim))**2 / prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2, alp_)  )
        lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           1) = max( lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),&
            tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) + prim(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,beta(idim)) / prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            alp_) )
        lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           2) = min( lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2),&
            -tmp1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) + prim(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,beta(idim)) / prim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            alp_) )
     end if
  ...
  subroutine grmhd_get_divb(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2, Bvector, divb, fourthorder)
    use mod_global_parameters
    use mod_physics
    use mod_geometry
    ...
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2
    double precision, intent(in)    :: bvector(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:ndir)
    ...
    if ( stagger_grid ) then
      ...
      do idir=1,ndim
        ...
        divb(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=divb(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2)+block%prims(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           idir)*block%surfaceC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           idir)-block%prims(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
      ...
      !select case(typediv)
      !case("central")
        call divvector(bvector(ixImin1:ixImax1,ixImin2:ixImax2,1:ndir),ixImin1,&
           ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2,&
           divb(ixImin1:ixImax1,ixImin2:ixImax2),fourthorder)
      !case("limited")
