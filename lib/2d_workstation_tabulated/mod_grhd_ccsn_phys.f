...
contains
  ...
  subroutine grhd_ccsn_read_params(files)
    ...
    namelist /grhd_ccsn_list/ evolve_hydro,  oneDcore, r_core, use_GR,&
        tolerance, iter_max, lfac_max
...
111    close(unitpar)
  ...
  subroutine grhd_ccsn_phys_init()
    ...
    call grhd_ccsn_phys_add_source_init()
     call grhd_ccsn_phys_one_d_core_init()
  ...
  subroutine grhd_ccsn_update_eos(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    do ix2 = ixOmin2,ixOmax2 
       call grhd_ccsn_update_eos_one_point(prim(ix1,ix2,:))
    enddo
    enddo
  end subroutine grhd_ccsn_update_eos

  !> Calculate cmax_idim within ixO^L
  subroutine grhd_ccsn_get_cmax(prim, x, ixImin1,ixImin2,ixImax1,ixImax2,&
  ...
  subroutine grhd_ccsn_get_csound2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    do ix2 = ixOmin2,ixOmax2 
       ...
       call eos_get_cs2_one_grid(csound2(ix1,ix2),prim(ix1,ix2, rho_),prim(ix1,&
          ix2, eps_), ye=prim(ix1,ix2, ye_), temp=prim(ix1,ix2, temp_))
  ...
  subroutine grhd_ccsn_get_lfac2(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
  ...
  subroutine grhd_ccsn_get_tilde_S(ps_in,ixImin1,ixImin2,ixImax1,ixImax2,&
     ixOmin1,ixOmin2,ixOmax1,ixOmax2,tilde_S)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImax1,ixImax2,&
        ixOmin1,ixOmin2,ixOmax1,ixOmax2
    type(state), intent(in)         :: ps_in
  ...
  subroutine grhd_ccsn_get_dt(w, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
  ...
  subroutine grhd_ccsn_check_prim(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
