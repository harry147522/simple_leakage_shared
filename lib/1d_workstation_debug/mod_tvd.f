...
contains
  ...
  subroutine tvdlimit2(method,qdt,ixImin1,ixImax1,ixICmin1,ixICmax1,ixOmin1,&
    ...
    integer, intent(in) :: ixImin1,ixImax1, ixICmin1,ixICmax1, ixOmin1,ixOmax1,&
        idims
    double precision, dimension(ixGlo1:ixGhi1,nprim) :: wL, wR
    double precision, intent(in) :: x(ixImin1:ixImax1,1:ndim)
    double precision :: wnew(ixImin1:ixImax1,1:nprim)
    double precision :: fC(ixImin1:ixImax1,1:ncons,1:ndim)

    double precision:: workroe(ixGlo1:ixGhi1,1:nworkroe)
    double precision, dimension(ixGlo1:ixGhi1,nprim) :: wroeC
